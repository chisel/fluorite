Before we install our theme, you might want to [download the theme project]({{rootPrefix}}/assets/contents/fluorite-theme-plain.zip) and check the files against yours for any inconsistencies.
